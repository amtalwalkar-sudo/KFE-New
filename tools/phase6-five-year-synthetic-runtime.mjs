...
try{
  ...
  assert(await page.getByText('212.2117 KM/day',{exact:true}).count()>0,'frozen operating-KM forecast not visible')
  assert(await page.getByText('1.061058×',{exact:true}).count()>0,'frozen KM multiplier not visible')
