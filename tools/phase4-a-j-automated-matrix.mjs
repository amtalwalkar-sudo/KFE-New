...
const matrix = [
  ...
  ['C1','DEFERRED','Android overlay execution surface; physical/native execution is reserved for the final Phase 4 physical-device audit.'],
  ['C2','DEFERRED','Android overlay execution surface; physical/native execution is reserved for the final Phase 4 physical-device audit.'],
  ['C3','DEFERRED','Android overlay execution surface; physical/native execution is reserved for the final Phase 4 physical-device audit.'],
  ['C4','DEFERRED','Android overlay process/background behavior requires native execution and is reserved for the final Phase 4 physical-device audit.'],
  ['C5','DEFERRED','Android overlay bubble/minimize/reopen requires native execution and is reserved for the final Phase 4 physical-device audit.'],
  ...
  ['D5','PASS','Operational gap suite edits canonical vehicle master data in Admin, rereads the Work baseline, and starts a shift from the edited value.'],
  ['E1','DEFERRED','PWA↔Android-overlay mixed-surface execution requires native overlay runtime and is reserved for the final Phase 4 physical-device audit.'],
  ['E2','DEFERRED','PWA↔Android-overlay mixed-surface execution requires native overlay runtime and is reserved for the final Phase 4 physical-device audit.'],
  ...
  ['F1','PASS','Operational gap suite exercises an active ride across browser foreground/background page lifecycle and verifies the active shift survives return; Android screen-off equivalence remains deferred.'],
  ['F2','DEFERRED','Force-stop behavior is Android/device-specific and reserved for the final Phase 4 physical-device audit.'],
  ['F3','DEFERRED','Screen lock/unlock behavior is Android/device-specific and reserved for the final Phase 4 physical-device audit.'],
  ...
  ['H4','PASS','Operational gap suite updates maintenance, loan, and driver-target source records once and verifies canonical Performance outputs without duplicate source records.'],
  ...
  ['I5','PASS','Operational gap suite verifies historical maintenance recovery across the Business Start Date boundary and the recovery horizon.'],
  ...
  ['J5','PASS','Operational gap suite asserts zero before Business Start Date, activation on the date, persistence after it, and expiry at the 12-month boundary.'],
...
console.log('PHASE4_AJ_MATRIX_RESULT ' + JSON.stringify({
  rule: 'PASS only when automated executable evidence exists; Android/native-only scenarios are DEFERRED; automated PASS is supporting evidence and does not replace real-device audit.',
