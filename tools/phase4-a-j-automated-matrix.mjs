...
const matrix = [
  ...
  ['A5','NOT_EXECUTED','Offline CNG refuel flow is not fully exercised by current automated gate.'],
  ['B1','PASS','Runtime gate verifies start-odometer gate and visible recovery path.'],
  ['B2','NOT_EXECUTED','Personal-KM/Dead-KM classification is not fully asserted by the current matrix runner.'],
  ['B3','NOT_EXECUTED','Accidental Offline while an active ride exists is not fully automated.'],
  ...
  ['B6','NOT_EXECUTED','Trip duplicate-tap idempotency is not yet directly asserted.'],
  ...
  ['D2','NOT_EXECUTED','True browser offline network-loss continuity is not directly exercised.'],
  ...
  ['F5','NOT_EXECUTED','Network loss/recovery is not directly simulated by the current gate.'],
  ['G1','PASS','Runtime gate supplies geolocation and verifies GPS control behavior.'],
  ['G2','NOT_EXECUTED','Explicit permission denial/recovery is not fully exercised.'],
  ['G3','NOT_EXECUTED','Explicit GPS-unavailable degraded mode is not fully exercised.'],
  ['G4','NOT_EXECUTED','Permission restoration without duplicate records is not fully exercised.'],
  ...
  ['H2','NOT_EXECUTED','Daily-total reconciliation is not separately asserted by this runner.'],
  ...
  ['I1','NOT_EXECUTED','Close-one-day/open-next-day lifecycle is not separately executed here.'],
  ['I2','NOT_EXECUTED','Cross-day odometer carry is not separately executed here.'],
  ['I3','NOT_EXECUTED','Cross-day financial carry is not separately executed here.'],
  ...
  ['J1','NOT_EXECUTED','Zero-value fare/expense boundary is not separately executed here.'],
  ['J2','NOT_EXECUTED','Same-odometer boundary is not separately executed here.'],
  ['J3','NOT_EXECUTED','Large valid odometer-gap boundary is not separately executed here.'],
  ['J4','NOT_EXECUTED','Midnight/date-rollover boundary is not separately executed here.'],
