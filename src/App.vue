...
<template>
  <div class="viewport-wrapper">
    ...
    <nav class="bottom-nav" aria-label="Primary navigation">
      ...
      <button type="button" class="nav-item nav-item-placeholder" disabled aria-label="Timeline — coming soon">
