...
const CANONICAL_DB_VERSION = 13
const SYNTHETIC_DB_VERSION = 12
...
const openDatabase = name => new Promise((resolve, reject) => {
  ...
  request.onupgradeneeded = e => {
    ...
    createSimpleStore(db, 'settings', ['settingKey', 'updatedAt']); createSimpleStore(db, 'audit_history', ['entityId', 'entityType', 'action', 'createdAt']); createSimpleStore(db, 'settlements', ['settlementType', 'sourceType', 'sourceId', 'settledOn'])
