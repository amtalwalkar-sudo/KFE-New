...
const snapshot = { format: BACKUP_FORMAT, formatVersion: BACKUP_FORMAT_VERSION, source: { dbName: 'kanishka_kfe_canonical_db', dbVersion: 10 }, exportedAt: '2026-09-17T00:00:00.000Z', stores }
...
const migratedV1 = BackupService.readBackupText(BackupService.serializeBackup(legacyV1))
...
const malformed = structuredClone(record); malformed.stores.trips = [{ id: 'trip-1' }, { id: 'trip-1' }]
