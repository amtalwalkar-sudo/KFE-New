...
const suites = [
  ...
  'rideCapture.contract.js',
  'operationalRecords.contract.js',
  'phase5CalculationPerformance.contract.js',
  ...
  'phase7CapacitorAndroid.contract.js',
  'phase8BackupRestore.contract.js',
  'phase9CloudBackupSync.contract.js',
  'presentationImpact.contract.js',
  'deadKmPickupGps.contract.js',
  'kfeRideNotifications.contract.js',
  'timeline.contract.js',
  'syntheticData.contract.js',
