...
assert.equal(validateEndShiftEntry({ closingOdometer: 600, startOdometer: 100 }).requiresConfirmation, true)
assert.equal(validateEndShiftEntry({ closingOdometer: 600, startOdometer: 100 }).valid, false)
assert.equal(validateEndShiftEntry({ closingOdometer: 600, startOdometer: 100, confirmLargeDistance: true }).valid, true)
