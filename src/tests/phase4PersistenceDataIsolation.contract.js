...
assert(db.includes('const CANONICAL_DB_VERSION = 11'), 'Canonical schema version must remain 11')
...
assert(backup.includes("source: { dbName: 'kanishka_kfe_canonical_db', dbVersion: 11 }"), 'Backups must identify canonical source DB')
