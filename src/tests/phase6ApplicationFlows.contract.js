...
assert.match(work,/Start Shift/); assert.match(work,/End Shift|Offline/); assert.match(work,/Current Odometer|startOdometer/i); assert.match(work,/Today.?s Target|TODAY.?S TARGET/i)
