...
assert.match(service, /FLAG_NOT_FOCUSABLE/)
assert.match(service, /InputMethodManager/)
assert.match(service, /Double\.isFinite/)
...
assert.match(service, /tripActiveState \?/)
assert.match(service, /Color\.argb\(242, 180, 70, 45\)/)
assert.match(service, /Color\.argb\(242, 22, 120, 92\)/)
...
assert.match(bridge, /acknowledgePendingEndRide/)
assert.match(work, /KfeOverlayService/)
assert.match(work, /syncAndroidOverlay/)
assert.match(work, /consumePendingEndRide/)
assert.match(work, /acknowledgePendingEndRide/)
assert.match(work, /if \(completed\)/)
assert.match(work, /pending\?\.fare/)
assert.match(work, /endTrip\(pending\.fare, pending\.toll \|\| '0', pending\.parking \|\| '0'\)/)
