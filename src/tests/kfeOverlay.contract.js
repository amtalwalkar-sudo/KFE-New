...
assert.match(service, /SWIPE\\nUP\\nKFE  ↑/)
assert.match(service, /Swipe up to open KFE/)
assert.match(service, /finalDy < -dp\(SWIPE_TRIGGER_DP\)/)
assert.match(service, /Math\.abs\(finalDy\) > Math\.abs\(finalDx\) \* 1\.2f/)
