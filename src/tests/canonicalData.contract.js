...
assert.match(canonicalDoc, /Provenance records where a value came from/)
assert.match(canonicalDoc, /Authority is separate from provenance/)
...
assert.match(canonicalDoc, /Operational status transitions are never implemented as deletion/)
...
assert.match(canonicalDoc, /supporting/infrastructure stores|supporting stores|infrastructure/i)
assert.match(canonicalDoc, /Historical.*as-of|historical references/i)
assert.match(breakEvenSource, /istDateKey/)
assert.match(targetSource, /effectiveDateKey/)
assert.match(canonicalDoc, /effective-dated authoritative/i)
...
assert.match(canonicalDoc, /canonical-data-changed notification/)
