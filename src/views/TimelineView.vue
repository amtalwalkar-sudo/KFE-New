...
const load = async () => { loading.value=true; error.value=''; try { trips.value=await WorkService.getAllTrips() } catch(e) { error.value=e?.message||'Unable to load timeline.' } finally { loading.value=false } }
