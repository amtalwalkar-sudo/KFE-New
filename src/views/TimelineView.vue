...
<style scoped>
.timeline{max-width:760px;margin:auto;padding:20px 16px 30px}header{display:flex;justify-content:space-between;align-items:center;margin-bottom:10px}.eyebrow{margin:0 0 4px;font-size:.62rem;font-weight:900;letter-spacing:.1em;color:var(--kfe-muted-text,#667085)}h1{margin:0;font-size:1.2rem}.today,.period button,.edit,.delete,.editor-head button{border:1px solid var(--kfe-ui-border,#e4e7ec);background:var(--kfe-ui-surface,#fff);border-radius:10px;color:var(--kfe-ui-text,#101828);font-weight:850}.today{padding:9px 12px}.breadcrumbs{display:flex;gap:6px;align-items:center;flex-wrap:wrap;margin:4px 0 12px;font-size:.68rem;font-weight:800;color:#667085}.breadcrumbs b{margin-left:6px}.slider{display:grid;grid-template-columns:repeat(4,1fr);gap:5px;padding:5px;border:1px solid var(--kfe-ui-border,#e4e7ec);background:var(--kfe-ui-surface,#fff);border-radius:14px}.slider button{border:0;border-radius:10px;padding:10px 5px;background:transparent;color:#667085;font:inherit;font-size:.7rem;font-weight:850}.slider button.active{background:#eff6ff;color:#2563eb}.period{display:flex;align-items:center;justify-content:space-between;margin:10px 0}.period button{width:38px;height:38px;font-size:1.3rem}.period strong{font-size:.8rem}.day-snapshot,.summary-card{display:grid;grid-template-columns:repeat(2,1fr);gap:8px;margin-bottom:14px}.day-snapshot>div,.summary-card>div{display:flex;flex-direction:column;gap:4px;padding:11px;background:#fff;border:1px solid #e4e7ec;border-radius:11px}.day-snapshot span,.summary-card span{font-size:.64rem;color:#667085;font-weight:750}.day-snapshot strong,.summary-card strong{font-size:.84rem}.summary-card.wide{grid-template-columns:repeat(4,1fr)}.event,.personal-event{display:flex;gap:10px;align-items:flex-start;padding:13px 0;border-bottom:1px solid #e4e7ec}.event time,.personal-event time{width:58px;flex:0 0 58px;font-size:.67rem;font-weight:850;color:#667085}.event>div:nth-child(2),.personal-event>div{min-width:0;flex:1}.top{display:flex;justify-content:space-between;gap:8px}.top strong,.personal-event strong{font-size:.78rem}.top small{font-size:.62rem;color:#079455;font-weight:800}.route{margin-top:4px;font-size:.76rem;line-height:1.35;overflow-wrap:anywhere}.meta,.personal-event small{margin-top:4px;font-size:.65rem;color:#667085}.edit,.delete{padding:7px 9px}.actions{display:flex;gap:5px}.delete{color:#b42318}.fuel{background:#fafafa}.personal-event span{display:block;margin-top:5px;font-weight:900;font-size:.85rem}.groups{display:grid;gap:8px}.groups button{display:grid;grid-template-columns:1fr auto 18px;align-items:center;gap:8px;text-align:left;padding:13px;border:1px solid #e4e7ec;background:#fff;border-radius:12px}.groups span{display:flex;flex-direction:column;gap:4px}.groups b{font-size:.78rem}.groups small{font-size:.64rem;color:#667085}.groups strong{font-size:.76rem}.groups i{font-style:normal;font-size:1.2rem;color:#667085}.state{padding:20px;text-align:center;color:#667085;font-size:.76rem}.error{color:#b42318}.overlay{position:fixed;inset:0;background:rgba(16,24,40,.38);display:grid;place-items:end center;padding:16px;z-index:10000}.editor{width:min(520px,100%);background:#fff;border-radius:16px;padding:18px;box-sizing:border-box}.editor-head{display:flex;justify-content:space-between;align-items:flex-start}.editor-head h2{margin:0;font-size:1rem}.editor-head button{font-size:1.2rem;padding:5px 9px}.editor label{display:block;margin:12px 0;font-size:.72rem;font-weight:800}.editor input,.editor select{display:block;width:100%;box-sizing:border-box;margin-top:5px;padding:10px;border:1px solid #cfd4dc;border-radius:8px;font:inherit}.save{width:100%;padding:12px;border:0;border-radius:10px;background:#2563eb;color:#fff;font-weight:900}.calculated{padding:10px;border-radius:8px;background:#f2f4f7;font-size:.68rem;color:#667085}.check{display:flex!important;gap:8px;align-items:center}.check input{width:auto!important;margin:0!important}@media(max-width:560px){.summary-card.wide{grid-template-columns:repeat(2,1fr)}}
</style>
