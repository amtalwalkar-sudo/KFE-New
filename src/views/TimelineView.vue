  ...
  <section class="timeline">
    ...
    <Teleport to="body">
      ...
      <div v-if="timelineKeypadVisible" class="kfe-number-pad timeline-number-pad" aria-label="KFE number pad">
        ...
        <div class="number-pad-grid"><button v-for="key in ['1','2','3','4','5','6','7','8','9','clear','0','decimal','backspace']" :key="key" type="button" @pointerdown.stop.prevent="timelineKeypadPress(key)"><span v-if="key==='backspace'">⌫</span><span v-else-if="key==='clear'">C</span><span v-else-if="key==='decimal'">.</span><span v-else>{{key}}</span></button></div>
