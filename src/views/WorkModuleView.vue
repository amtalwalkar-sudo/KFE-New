...
<template>
  <div class="cockpit" :class="{\n    'cockpit--offline': !store.isOnline,\n    'cockpit--online': store.isOnline && !store.isTripActive && !endShiftOpen,\n    'cockpit--trip': store.isTripActive,\n    'cockpit--end-shift': endShiftOpen,\n    'cockpit--fuel': fuelFormOpen\n  }">
