...
const toggleOnline = async () => { if(store.isTripActive)return fail('End the active Trip before going Offline.'); if(store.isOnline){ endShiftOpen.value=true; return } return goOnline() }
